...
int main(int argc, char **argv) {
    std::cout << "=== Placement Only Mode ===" << std::endl;
    ...
    std::ofstream out(output_path.string() + "/placement_summary.txt");
    ...
    std::cout << "\n=== Placement completed. Results saved to: " << output_path << " ===" << std::endl;
    return 0;
}
